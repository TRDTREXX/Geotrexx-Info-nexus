...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#121826] text-gray-300 border-t-4 border-[#C8102E] mt-16 pt-12 pb-6 font-sans">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-gray-800 pb-10">
          ...
          <div className="space-y-6 lg:col-span-1">
            <Link href="/" className="inline-block group">
              <h2 className="text-3xl font-black text-white uppercase tracking-tighter" style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
            ...
            <Link href="/founders" className="inline-block border border-gray-500 text-gray-300 hover:bg-white hover:text-black text-xs font-bold uppercase tracking-widest px-6 py-3 transition-colors">
              Meet The Founders
            </Link>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-xs font-bold text-white uppercase tracking-widest font-mono border-b border-gray-800 pb-2">
              Contact Desk
            </h3>
            ...
            <ul className="space-y-4 text-sm font-bold text-gray-400">
              ...
              <li>
                <a href="https://x.com/trexx84" target="_blank" rel="noopener noreferrer" className="hover:text-[#C8102E] transition-colors flex items-center group">
                  <svg className="w-5 h-5 mr-3 text-gray-500 group-hover:text-[#C8102E] transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.007 4.15H5.028z"/></svg>
                  X (Twitter)
                </a>
              </li>
              <li>
        ...
        {/* Legal & Compliance */}
        <div className="mt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono text-gray-500">
          <p>© {currentYear} Geotrexx Media Group. All rights reserved.</p>
          <div className="flex items-center gap-4">
            <span>AdSense Publisher Compliant</span>
            <span>•</span>
